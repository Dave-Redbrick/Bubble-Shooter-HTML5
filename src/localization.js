...
const translations = {
  en: {
    ...
    leaderboardUpdateName: "Update Name",
    leaderboardNoScores: "No scores yet.",
    leaderboardNewHighPrompt: "New High Score!",
    leaderboardUpdateNamePrompt: "Update Your Name",
    leaderboardSubmit: "Submit",
  ...
  fr: {
    ...
    newHighScore: "🎉 Nouveau record ! Félicitations ! 🎉",
    continue: "Continuer",
    ...
    leaderboardDate: "Date",
    leaderboardUpdateName: "Mettre à jour le nom",
    leaderboardNoScores: "Aucun score pour le moment.",
    leaderboardNewHighPrompt: "Nouveau meilleur score !",
    leaderboardUpdateNamePrompt: "Mettez à jour votre nom",
    leaderboardSubmit: "Envoyer",
    leaderboardSkip: "Ignorer",
  },
  it: {
    gameTitle: "Lanceur de Billes en Verre",
    score: "Punteggio",
    ...
    newHighScore: "🎉 Nuovo record! Congratulazioni! 🎉",
    continue: "Continua",
    ...
    tutorialNext: "Avanti",
    tutorialFinish: "Fine",
    leaderboardRank: "Classifica",
    leaderboardPlayer: "Giocatore",
    leaderboardScore: "Punteggio",
    leaderboardLevel: "Livello",
    leaderboardDate: "Data",
    leaderboardUpdateName: "Aggiorna nome",
    leaderboardNoScores: "Nessun punteggio ancora.",
    leaderboardNewHighPrompt: "Nuovo punteggio massimo!",
    leaderboardUpdateNamePrompt: "Aggiorna il tuo nome",
    leaderboardSubmit: "Invia",
    leaderboardSkip: "Salta",
  },
  de: {
    ...
    newHighScore: "🎉 Neuer Highscore! Glückwunsch! 🎉",
    continue: "Fortsetzen",
    newGame: "Neues Spiel",
    ...
    leaderboardUpdateName: "Name aktualisieren",
    leaderboardNoScores: "Noch keine Punktzahlen.",
    leaderboardNewHighPrompt: "Neuer Highscore!",
    leaderboardUpdateNamePrompt: "Aktualisiere deinen Namen",
    leaderboardSubmit: "Absenden",
    leaderboardSkip: "Überspringen",
  },
  es: {
    ...
    newHighScore: "🎉 ¡Nuevo récord! ¡Felicidades! 🎉",
    continue: "Continuar",
    newGame: "Nuevo Juego",
    ...
    leaderboardDate: "Fecha",
    leaderboardUpdateName: "Actualizar nombre",
    leaderboardNoScores: "Aún no hay puntuaciones.",
    leaderboardNewHighPrompt: "¡Nuevo récord!",
    leaderboardUpdateNamePrompt: "Actualiza tu nombre",
    leaderboardSubmit: "Enviar",
    leaderboardSkip: "Omitir",
  },
  "zh-CN": {
    gameTitle: "珠子射手",
    score: "分数",
    ...
    leaderboardLevel: "等级",
    leaderboardDate: "日期",
    leaderboardUpdateName: "更新姓名",
    leaderboardNoScores: "暂无分数。",
    leaderboardNewHighPrompt: "新高分！",
    leaderboardUpdateNamePrompt: "更新你的姓名",
    leaderboardSubmit: "提交",
    leaderboardSkip: "跳过",
  },
  ja: {
    gameTitle: "ビーズシューター",
    ...
    newHighScore: "🎉 新しいハイスコア！おめでとうございます！🎉",
    continue: "続ける",
    newGame: "新しいゲーム",
    statistics: "統計",
    achievements: "実績",
    ...
    leaderboardDate: "日付",
    leaderboardUpdateName: "名前を更新",
    leaderboardNoScores: "まだスコアがありません。",
    leaderboardNewHighPrompt: "新しいハイスコア！",
    leaderboardUpdateNamePrompt: "名前を更新してください",
    leaderboardSubmit: "送信",
    leaderboardSkip: "スキップ",
  },
  ko: {
    gameTitle: "비즈 슈터",
    score: "점수",
    ...
    leaderboardLevel: "레벨",
    leaderboardDate: "날짜",
    leaderboardUpdateName: "이름 변경",
    leaderboardNoScores: "아직 점수가 없습니다.",
    leaderboardNewHighPrompt: "새로운 최고 점수!",
    leaderboardUpdateNamePrompt: "이름 변경",
    leaderboardSubmit: "제출",
    leaderboardSkip: "건너뛰기",
  },
};
